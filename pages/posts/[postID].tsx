export default function Page() { return <div>dewde</div> }

// import { TableViewDataRow } from "@components/data/tableView";
...
// {
//     const getTableData = (): TableViewDataRow[] => props.postData.map(x =>
//     {
//         return {
//             data: [
//                 x.isActive ? 'Published' : 'Not Published'],
//             event: {
//                 selector: x.postId,
